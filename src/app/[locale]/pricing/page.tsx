...
export default function PricingPage() {
  ...
  const plans = [
    { id: 'briefing', price: "$20,000", icon: <Shield className="w-6 h-6" /> },
    { id: 'blueprint', price: "$45,000", icon: <Zap className="w-6 h-6" />, highlight: true },
    { id: 'advisor', price: "$8,000 / mo", icon: <TrendingUp className="w-6 h-6" /> }
  ];
    ...
    <div className="py-24">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-3">
          {plans.map((plan) => {
            const features = t.raw(`features.${plan.id}`) as string[];
            return (
